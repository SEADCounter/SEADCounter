...
public:
	...
	virtual void dynamic_sead_insert(const char *str, int c, long long int *gamma,bool sp_negative=true) {}
	virtual int dynamic_sead_query(const char *str, long long int *gamma,bool sp_negative=true) = 0;
	virtual void static_sead_insert(const char *str, int l_sign, long long int *gamma,bool sp_negative=true) {}
	virtual int static_sead_query(const char *str, int l_sign, long long int *gamma,bool sp_negative=true) = 0;
